...
live2d_settings['waifuSize'] = '500x680';
...
live2d_settings['waifuDraggableRevert'] = false;
    !function (t) {
        ...
        o.prototype.createModel = function () {
            ...
            prototype.tapEvent = function (t, i) {
            // console.log("tap"+t+" "+i);
				if ($.default.DEBUG_LOG)
					console.log("tapEvent view x:" + t + " y:" + i);

				for (var j = 0; j < this.models.length; j++) {

					if (this.models[j].hitTest($.default.HIT_AREA_HEAD, t, i)) {

						if ($.default.DEBUG_LOG)
							console.log("Tap face.");
						this.models[j].setRandomExpression();

					}else if (this.models[j].hitTest($.default.HIT_AREA_BODY, t, i)) {

						if ($.default.DEBUG_LOG)
							console.log("Tap body." + " models[" + j + "]");
						this.models[j].startRandomMotion($.default.MOTION_GROUP_TAP_BODY,
							$.default.PRIORITY_NORMAL);

					}else if (this.models[j].hitTestCustom('head', t, i)) {

						if ($.default.DEBUG_LOG)
							console.log("Tap face.");
						this.models[j].startRandomMotion($.default.MOTION_GROUP_FLICK_HEAD,
							$.default.PRIORITY_NORMAL);

					}else if (this.models[j].hitTestCustom('breast', t, i)) {

						if ($.default.DEBUG_LOG)
							console.log("Tap breast.");
						this.models[j].startRandomMotion($.default.MOTION_GROUP_TAP_BREAST,
							$.default.PRIORITY_NORMAL);

					}else if (this.models[j].hitTestCustom('body', t, i)) {
        ...
        o.prototype = new n.L2DBaseModel, o.prototype.load = function (t, i, e) {
                        ...
                        r.loadTexture(i, o, function () {
                            if (r.isTexLoaded) {
                                ...
                                if (null != r.modelSetting.getHitAreasCustom()) {
									...
									null != s.breast_x && (h.default.hit_areas_custom_breast_x = s.breast_x),
									null != s.breast_y && (h.default.hit_areas_custom_breast_y = s.breast_y)
            ...
            o.prototype.startMotion = function(t, i, e)
			{
                if (h.default.DEBUG_LOG) {
                    console.log("startMotion : " + t + " " + i + " " + e);
                }
				var r = this.modelSetting.getMotionFile(t, i);
        ...
        }, o.prototype.hitTestCustom = function(t, i, e)
		{
			if (t == 'head'){
				...
				return this.hitTestSimpleCustom(h.default.hit_areas_custom_breast_x, h.default.hit_areas_custom_breast_y, i, e);
			}else{
				return false;
			}
		}
